...
insert into menu (category_id, name, price, image, create_at) values (1L, '아메리카노', 4000, 'https://image', now());
insert into menu (category_id, name, price, image, create_at) values (1L, '카페모카', 4500, 'https://image', now());
